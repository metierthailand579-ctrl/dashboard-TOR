...
- **กลุ่ม 2 ระบบ** (อ่านจากคอลัมน์ใน Excel โดยตรง):
  - ระบบ A — กลุ่มงาน (work_category): กลุ่มหลัก → กลุ่มย่อย
  - ระบบ B — โอกาสธุรกิจ Metier (service area): NOT_APPLICABLE = ไม่ใช่โอกาส
